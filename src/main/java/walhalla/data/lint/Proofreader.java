...
public class Proofreader {
    ...
    public static final Linter LINTER = new Linter()
            ...
            // Token rules
            .addTokenRule("敵を倒すとまれにゴールドを入手するトークンを使役", result -> result.addToken("敵を倒すとまれにゴールドを入手")) // マーチャント系
            .addTokenRule("敵を倒すとまれにゴールドを入手できるトークンを使役", result -> result.addToken("敵を倒すとまれにゴールドを入手")) // マーチャント系
            .addTokenRule("ブロック数2で敵を倒すとまれにゴールドを入手するトークンを使役", result -> result.addToken("敵を倒すとまれにゴールドを入手", "ブロック数：2")) // マーチャント系
            .addTokenRule("遠距離攻撃を行い敵を倒すとまれにゴールドを入手するトークンを使役", result -> result.addToken("敵を倒すとまれにゴールドを入手", "遠距離攻撃")) // マーチャント系
            ...
            .addRule("スキル中、遠距離攻撃の対象にならない", "\nスキル中、敵の遠距離攻撃の対象にならない\n")
            .addRule("スキル中、敵の遠距離攻撃の対象にならない", "\nスキル中、敵の遠距離攻撃の対象にならない\n")
            .addRule("スキル中、遠距離攻撃の対象にならず", "\nスキル中、敵の遠距離攻撃の対象にならない\n")
            .addRule("スキル中、敵の遠距離攻撃の対象にならず", "\nスキル中、敵の遠距離攻撃の対象にならない\n")
            .addRule("スキル中は、遠距離攻撃の対象にならない", "\nスキル中、敵の遠距離攻撃の対象にならない\n")
            .addRule("スキル中は、敵の遠距離攻撃の対象にならない", "\nスキル中、敵の遠距離攻撃の対象にならない\n")
            .addRule("スキル中のみ、遠距離攻撃の対象にならない", "\nスキル中、敵の遠距離攻撃の対象にならない\n")
            .addRule("スキル中のみ、敵の遠距離攻撃の対象にならない", "\nスキル中、敵の遠距離攻撃の対象にならない\n")
            .addRule("スキル使用時、遠距離攻撃の対象にならない", "\nスキル中、敵の遠距離攻撃の対象にならない\n")
            .addRule("スキル使用時、敵の遠距離攻撃の対象にならない", "\nスキル中、敵の遠距離攻撃の対象にならない\n")

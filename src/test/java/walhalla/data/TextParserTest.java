...
public class TextParserTest {
    ...
    void extractArtistName() {
        ...
        assert TextParser.extractArtistName("[https://twitter.com/cyocyo_tasaka 田阪新之助]<br>(Coloring collaboration: [http://exit776.sakura.ne.jp/ 立見いづく])")
                .equals("田阪新之助");
        assert TextParser.extractArtistName("[http://www1.plala.or.jp/chesha/　わざきた] <br> (Coloring collaboration: [http://shokushu.jp/ 触手さん])")
                .equals("わざきた");
        ...
        assert TextParser.extractArtistName("非公開 (Undisclosed)<br/>Possibly [http://www116.sakura.ne.jp/~kuromoji/index.htm もりたん]").equals("");
        ...
        assert TextParser.extractArtistName("[http://puus.sakura.ne.jp/ はんぺん]<br>(Coloring collaboration: [http://exit776.sakura.ne.jp/ 立見いづく])")
                .equals("はんぺん");
        assert TextParser.extractArtistName("一斎楽<!-- No official link provided on gcwiki. Japanese players don't even seem to know for sure how to pronounce his name (see http://sennenaigis.blog.fc2.com/blog-entry-1833.html), though the first guess seem to be \\\"Issai-raku\\\" -->")
                .equals("一斎楽");
